...
export function VoiceTrainingSection({
  ...
  return (
    ...
    >
      <div className="mobile-section-safe mx-auto grid h-full min-h-0 w-full max-w-[1440px] grid-rows-[minmax(0,1fr)] items-center gap-8 px-4 pt-20 pb-4 sm:px-5 sm:py-8 xl:grid-cols-[minmax(19rem,0.7fr)_minmax(0,1.3fr)] xl:gap-14 xl:px-8 xl:py-28">
        <div
